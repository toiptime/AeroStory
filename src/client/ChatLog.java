   ...
   public static ChatLog getInstance() { //works together with disable()
    ...
    public void viewRecentAsDrop(MapleClient c) {
        ...
        try {
            ...
            c.announce(MaplePacketCreator.getNPCTalk(9010000, (byte) 0, "#eRecent Chat:#n\r\n"+(drop.length() > 1 ? drop : "Not enough data recorded"), "00 00", (byte) 0));
        } catch(ConcurrentModificationException cme) { cme.printStackTrace(System.err); }
        drop = null;
    }
